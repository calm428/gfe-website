...
export function SiteFooter() {
  return (
    <footer className="relative z-40 w-full border-b bg-primary/5">
      <div
        className="flex flex-col sm:flex-row gap-5 items-center bg-primary max-w-5xl p-5 sm:p-5 md:p-10 lg:mx-auto -mt-20 rounded-3xl mx-4 sm:mx-6 md:mx-8"
        style={{
          background:
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-1  md:grid-cols-1">
            {siteConfig.footerLinks.map((link, index) => (
              <Link
                key={index}
                href={link.href}
                className="flex items-center text-sm font-mont text-primary  rounded-lg hover:text-primary"
              >
                {link.title}
              </Link>
            ))}
