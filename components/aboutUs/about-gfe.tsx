...
export default function AboutGFE() {
  ...
  return (
    <section className=" flex flex-col items-center gap-20 py-20 lg:py-24">
      <p className="auth container text-justify font-sans text-base font-semibold text-black md:text-lg">
      ...
      <div className="justify-betwween container flex flex-col-reverse  lg:flex-row ">
        <div className="container flex flex-col justify-center gap-6 p-0 lg:w-2/3">
          <p className="auth text-justify font-sans text-base font-semibold text-muted-foreground md:text-lg">
            {t("about_us.GFE_section.para2")}
          </p>
          <p className="auth text-justify font-sans text-lg font-semibold text-muted-foreground">
          ...
          <div className="flex gap-6 rounded-md bg-gradient-to-br from-[#2BADFD] to-[#1570EF] p-6">
            ...
            <p className="auth font-sans text-base font-semibold text-primary-foreground">
