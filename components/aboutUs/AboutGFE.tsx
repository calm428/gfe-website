...
const AboutGFE = () => {
  return (
    <div className=" py-20 lg:py-24 flex flex-col items-center gap-20">
      ...
      <div className="flex  flex-col-reverse lg:flex-row gap-12 px-5 lg:px-0 lg:pl-24">
        <div className="flex flex-col gap-6 lg:w-2/3">
          <p className="auth font-mont text-base md:text-lg font-semibold text-muted-foreground">
          ...
          <div className="p-6 rounded-md flex gap-6 bg-gradient-to-br from-[#2BADFD] to-[#1570EF]">
            <div>
