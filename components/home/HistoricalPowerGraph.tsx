...
const HistoricalPowerGraph = () => {
  ...
  return (
    <div className="flex w-full flex-col justify-between space-y-5 bg-white p-10 drop-shadow-2xl xl:w-1/2">
      <h1 className="font-monument text-xl tracking-wider text-primary">
