      ...
      <div className="mt-12 grid w-full grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-6 container pt-5 max-w-xl justify-center">
          ...
          <p className="auth font-mont text-lg">
            ...
            power. Market prices are based on many factors, in our case we need
            a global process that consumes power around the world to measure
            ...
            earnings as an ideal situation for analysis, it consumes around 1%
            of the world{"'"}s energy.
          </p>
          <p className="auth font-mont text-lg ">
            This hash power and energy conversion to FIAT currency occurs in
            London and China, the equipment is very similar and the energy is
            the biggest geographic component variable. Often mining environments
            ...
            {"'"}s hard to tell the difference between server hosting and
            mining. The collective doesn{"'"}t discriminate in our server
            hosting; we sell our power to all. We provide ethically sourced
            power one KW at a time to global commons consumers.
          </p>
        </div>
      </div>
